...
export default function IyashikeiHeroMedia() {
  ...
  return (
    <div ref={rootRef} className="iyashikei-hero__media-root">
      {activeImage ? (
        <div className="iyashikei-hero__slides">
          <img
            key={activeImage}
            src={activeImage}
            alt=""
            className="iyashikei-hero__slide"
            decoding="async"
          />
        </div>
      ) : null}
