...
import './Avatar.css';
import GameScalableContainer from '../voidborn/GameScalableContainer';
...
export const Game: React.FC<Props> = ({
    ...
    return (
      <GameScalableContainer>
        <div className="game-stage game-stage--booting game-stage--error">
          <p>Could not open a trail. Sign in, pick a deck, and try again.</p>
          <Button
            type="button"
            variant="primary"
            size="md"
  ...
  if (bootError || !match || !boardMatch) {
    return (
      <GameScalableContainer>
        <div className="game-stage game-stage--booting game-stage--error">
          <p>{bootError ?? 'Trail unavailable.'}</p>
          <Button
            type="button"
            variant="primary"
            size="md"
      ...
      <div
        ...
        <div className="game-zone-controls" ref={controlsRef} aria-label="Turn controls">
          <div className="game-turn-box">
            <span>Trail {match.turn}</span>
            <span>{match.phase === 'hero_main' ? 'Field phase' : 'Resolution'}</span>
